...
<div class="practice-sec sec" id="practice-sec">
    <div class="container">
        ...
        <div class="text-sec">
            ...
            <?php if($cta_button): ?>
                <a href="<?= $cta_button['url'] ?>" target="<?= $cta_button['target'] ?>" class="cta-btn hollow-btn "><?= $cta_button['title'] ?> <i class="fas fa-chevron-right"></i></a>
            <?php endif?>
        </div>
        <!-- PRACTICE SLIDER -->
            ...
            <div class="flexslider-practice carousel">
                <ul class="slides">
                    ...
                    ?>
                        ...
                        <li>
                            <div class="img-wrap">
                                <img src="<?= $practice_areas_fields['slider_image']; ?>" alt="practice image">
                                <div class="hover">
